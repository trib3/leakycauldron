...
class GraphQLResourceTest {
    ...
    @Test
    fun testUnauthorizedErrorQuery() =
        runBlocking {
    ...
    @Test
    fun testCancellableQueryCompletes() =
        runBlocking {
            var reached = false
            val requestId = UUID.randomUUID().toString()
            val job =
    ...
    @Test
    fun testCancellableQueryNeedsAuthToCancel() =
        runBlocking {
            var reached = false
            val requestId = UUID.randomUUID().toString()
            val job =
    ...
    @Test
    fun testCancellableQueryWithoutAuth() =
        runBlocking {
            var reached = false
            val requestId = UUID.randomUUID().toString()
            val job =
